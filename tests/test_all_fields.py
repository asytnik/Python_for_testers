...
def test_all_fields_on_home_page(apl):
    ...
    assert info_from_home_page.lastname == clear(info_from_edit_page.lastname)
    assert info_from_home_page.firstname == clear(info_from_edit_page.firstname)
    assert info_from_home_page.address == clear(info_from_edit_page.address)
